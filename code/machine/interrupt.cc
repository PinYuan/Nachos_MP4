...
int Interrupt::WriteFile(char *msg, int _size, OpenFileId id) 
{
    return kernel->Write(msg, _size, id);
}

int Interrupt::ReadFile(char *msg, int _size, OpenFileId id) {
    return kernel->Read(msg, _size, id);
}
